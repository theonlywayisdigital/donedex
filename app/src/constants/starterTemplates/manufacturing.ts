    ...
    sections: [
      {
        ...
        items: [
          ...
          { label: 'Equipment Type', item_type: 'dropdown', is_required: true, options: ['CNC Machine', 'Press', 'Conveyor', 'Packaging Machine', 'Assembly Line', 'Robot/Automation', 'Pump', 'Compressor', 'HVAC Unit', 'Electrical Panel', 'Other'] },
          ...
          { label: 'Maintenance Type', item_type: 'dropdown', is_required: true, options: ['Preventive', 'Corrective', 'Predictive', 'Emergency', 'Routine'] },
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Visual Inspection Notes', item_type: 'textarea' },
        ],
      },
      {
        ...
        items: [
          ...
          { label: 'Mechanical Notes', item_type: 'textarea' },
        ],
      },
      {
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Performance Notes', item_type: 'textarea' },
        ],
      },
      {
        ...
        items: [
          ...
          { label: 'Parts Replaced Details', item_type: 'textarea' },
          { label: 'Adjustments Made', item_type: 'textarea' },
      ...
      },
      {
        name: 'Completion',
        items: [
          { label: 'Equipment Status After Maintenance', item_type: 'dropdown', is_required: true, options: ['Operational', 'Operational with Limitations', 'Requires Further Repair', 'Out of Service'] },
          { label: 'Follow-up Required', item_type: 'yes_no' },
          { label: 'Follow-up Description', item_type: 'textarea' },
          { label: 'Spare Parts Needed', item_type: 'textarea' },
    ...
    sections: [
      {
        ...
        items: [
          ...
          { label: 'Production Shift', item_type: 'dropdown', is_required: true, options: ['Day Shift', 'Evening Shift', 'Night Shift'] },
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Visual Check Notes', item_type: 'textarea' },
        ],
      },
      {
        ...
        items: [
          ...
          { label: 'Dimensional Notes', item_type: 'textarea' },
        ],
      },
      {
        ...
        items: [
          ...
          { label: 'Test Results Documentation', item_type: 'textarea' },
        ],
      },
      {
        ...
        items: [
          ...
          { label: 'Packaging Notes', item_type: 'textarea' },
        ],
      },
      {
        name: 'Defect Summary',
        items: [
          ...
          { label: 'Root Cause Analysis', item_type: 'textarea' },
          { label: 'Corrective Action Required', item_type: 'yes_no' },
          { label: 'Corrective Action Details', item_type: 'textarea' },
        ],
      },
      {
        name: 'Quality Decision',
        items: [
          { label: 'Batch Status', item_type: 'dropdown', is_required: true, options: ['Approved', 'Approved with Deviation', 'On Hold', 'Rejected', 'Requires Rework'] },
          { label: 'Rejection Quantity', item_type: 'number' },
          { label: 'Rework Quantity', item_type: 'number' },
          { label: 'Pass Rate (%)', item_type: 'number' },
          { label: 'Quality Notes', item_type: 'textarea' },
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Floor Notes', item_type: 'textarea' },
        ],
      },
      {
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Dock Notes', item_type: 'textarea' },
        ],
      },
      {
        name: 'Summary and Sign-Off',
        items: [
          { label: 'Overall Safety Rating', item_type: 'dropdown', is_required: true, options: ['Excellent', 'Good', 'Satisfactory', 'Needs Improvement', 'Unsatisfactory'] },
          ...
          { label: 'Follow-up Items', item_type: 'textarea' },
          { label: 'Inspector Signature', item_type: 'signature', is_required: true },
    ...
    sections: [
      {
        ...
        items: [
          ...
          { label: 'Shift', item_type: 'dropdown', is_required: true, options: ['Day Shift', 'Evening Shift', 'Night Shift'] },
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Head Protection Notes', item_type: 'textarea' },
        ],
      },
      {
        ...
        items: [
          ...
          { label: 'Eye Protection Notes', item_type: 'textarea' },
        ],
      },
      {
        ...
        items: [
          ...
          { label: 'Hearing Protection Notes', item_type: 'textarea' },
        ],
      },
      {
        ...
        items: [
          ...
          { label: 'Hand Protection Notes', item_type: 'textarea' },
        ],
      },
      {
        ...
        items: [
          ...
          { label: 'Foot Protection Notes', item_type: 'textarea' },
        ],
      },
      {
        ...
        items: [
          ...
          { label: 'Respiratory Notes', item_type: 'textarea' },
        ],
      },
      {
        ...
        items: [
          ...
          { label: 'Body Protection Notes', item_type: 'textarea' },
        ],
      },
      {
        ...
        items: [
          ...
          { label: 'Availability Notes', item_type: 'textarea' },
        ],
      },
      {
        name: 'Audit Summary',
        items: [
          ...
          { label: 'Audit Rating', item_type: 'dropdown', is_required: true, options: ['Excellent (95-100%)', 'Good (85-94%)', 'Satisfactory (75-84%)', 'Needs Improvement (65-74%)', 'Unsatisfactory (<65%)'] },
