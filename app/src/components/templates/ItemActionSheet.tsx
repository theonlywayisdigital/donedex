      ...
      >
        <View style={styles.sheet} onStartShouldSetResponder={() => true}>
          <View style={styles.header}>
            ...
            <Text style={styles.headerSubtitle}>Item Actions</Text>
          </View>
          ...
          <View style={styles.actionGroup}>
            ...
            >
              ...
              <View style={styles.actionContent}>
                <Text style={styles.actionLabel}>Duplicate Item</Text>
          ...
          <View style={styles.actionGroup}>
            <Text style={styles.groupLabel}>Move Item</Text>
          ...
          <View style={styles.actionGroup}>
            ...
            >
              ...
              <Text style={[styles.actionLabel, styles.dangerText]}>Delete Item</Text>
            </TouchableOpacity>
          </View>
